...
export default function Navbar() {
  ...
  return (
    <nav className="h-[70px] flex justify-between items-center gap-4 px-2 md:px-8 w-full bg-neutral-primary dark:bg-black-dark">
      <h1 className={`${roboto.className} hidden md:block dark:text-white text-2xl font-bold`}>News</h1>

      <button className="bg-white-secondary dark:bg-black-light border-solid border-[1px] border-neutral-200 text-neutral-600 dark:border-neutral-600 dark:text-neutral-200 flex items-center py-[6px] px-4 rounded-md w-full grow max-w-[340px] md:max-w-[300px] hover:bg-white-primary dark:hover:bg-black-medium transition-all" onClick={openSearch}>
      ...
      <div className="flex gap-2">
        <button className="grow bg-white-terciary dark:bg-black-medium w-10 h-10 flex items-center justify-center text-neutral-600 dark:text-neutral-300 rounded-md">
